...
export enum  ConstantsValidationMessage {
  NAME_REQUIRED = 'El nombre es obligatorio',
  NAME_MAXLENGTH = 'El nombre debe ser menor a 50 caracteres',
  NAME_MINLENGTH = 'El nombre debe ser mayor a 3 caracteres',
  NAME_PATTERN = 'No debe contener caracteres especiales distintos de # y + ni tampoco números',
